...
internal data class MySqlTestSchemas(val main: String, val tasks: String)

internal object MySqlTestSchemaUrls {
  fun allocate(mainUrl: String, tasksUrl: String): MySqlTestSchemas {
  ...
  fun withSchema(url: String, schema: String): String {
...
class MySqlTestSchemaEnvironmentPostProcessor : EnvironmentPostProcessor, Ordered {

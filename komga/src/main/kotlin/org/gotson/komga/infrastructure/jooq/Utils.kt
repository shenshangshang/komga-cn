...
fun Field<String>.noCase() = this.collate("utf8mb4_0900_ai_ci")
...
// MySQL utf8mb4_0900_ai_ci collation is accent-insensitive, so comparisons work without stripping accents
fun Field<String>.udfStripAccents() = this
